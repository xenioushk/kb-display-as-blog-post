...
class AdminEnqueue {
	...
	public function __construct() {
		...
		$this->admin_script_slug = 'bkb_kdabp-admin';
	}
	...
	public function get_the_scripts() {
        ...
        //     KBDABP_PLUGIN_STYLES_ASSETS_DIR . 'admin.css',
        //     [],
        //     KBDABP_PLUGIN_VERSION
        // );

        wp_enqueue_script(
            $this->admin_script_slug,
            KBDABP_PLUGIN_SCRIPTS_ASSETS_DIR . 'admin.js',
            [ 'jquery' ],
            KBDABP_PLUGIN_VERSION, true
        );
	...
	private function get_the_localization_texts() {
		...
		// Localize scripts.
		// Frontend.
		// Access data: BkbmDabpAdminData.version
		wp_localize_script(
            $this->admin_script_slug,
            'BkbmDabpAdminData',
            [
				'version'      => KBDABP_PLUGIN_VERSION,
				'ajaxurl'      => esc_url( admin_url( 'admin-ajax.php' ) ),
				'product_id'   => KBDABP_PRODUCT_ID,
				'installation' => get_option( KBDABP_PRODUCT_INSTALLATION_TAG ),
			]
		);
	}
}
